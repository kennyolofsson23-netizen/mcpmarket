...
describe('Landing Page (src/app/page.tsx)', () => {
  ...
  it('renders How It Works section', () => {
    expect(COPY.emptyStates.noDeveloperServers.action.label).toBe('List Your First Server');
  });

  it('renders Features section', () => {
    expect(COPY.emptyStates.noSubscriptions.action.label).toBe('Browse Servers');
  });
