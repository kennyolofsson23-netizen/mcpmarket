...
export default function PricingPage() {
  return (
    <div className="container mx-auto px-4 py-16 max-w-4xl">
      ...
      <p className="text-center text-gray-600 mb-12">No upfront costs. We only earn when you do.</p>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {/* Basic tier */}
        <Card className="p-6">
          <h2 className="text-xl font-semibold mb-2">Basic</h2>
          <p className="text-3xl font-bold mb-1">Free to list</p>
          <p className="text-gray-500 mb-4">20% revenue share per transaction</p>
