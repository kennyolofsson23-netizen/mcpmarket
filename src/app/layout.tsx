...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "The Shopify for MCP servers. Manage, monetize, and scale your MCP tools.",
    images: [
      {
  ...
  twitter: {
    ...
    description:
      "The Shopify for MCP servers. Monetize your MCP tools with one-click billing.",
...
const softwareAppSchema = {
  ...
  name: "MCPmarket",
  description:
    "The Shopify for MCP servers. Paid MCP Server Marketplace + Billing Infrastructure.",
